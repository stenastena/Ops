...
if ([string]::IsNullOrEmpty($osType)) {    
    $osType = "Windows"
    Write-Host "No OsType specified, using the default option: $osType"
}
...
Set-AzVMOSDisk -VM $NewVmObject -ManagedDiskId $TargetOsDisk.Id -CreateOption Attach -$osType
